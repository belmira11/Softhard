      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-10 items-center">
        ...
        <div className="w-full lg:w-2/3 flex flex-col gap-4">
          ...
          <div className="flex flex-wrap gap-4 mt-6">
            ...
            <button className="flex items-center texy-black gap-2 py-2 px-6 rounded-full border border-gray-300 hover:bg-gray-100 ">
...
<div className="w-full lg:w-2/3 bg-orange-600 rounded-3xl overflow-hidden flex flex-col md:flex-row items-start p-2 gap-2">
  {/* Imagem */}
  ...
  <div className="w-full md:w-1/2">
    <div className="bg-white rounded-2xl shadow-md flex flex-col justify-start p-4 h-full min-h-[250px]">
      ...
      <h4 className="text-black font-semibold mt-24">
