...
const Banner = () => {
  return (
    <section className="p-30 bg-white">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-10 items-center">
        ...
        <div className="w-full lg:w-1/2 flex flex-col gap-4">
          ...
          <div className="flex flex-wrap gap-4 mt-6">
            ...
            <button className="flex items-center gap-2 py-2 px-6 rounded-full border border-gray-300 hover:bg-gray-100 transition">
        ...
        <div className="w-full lg:w-2/3 bg-orange-600 rounded-3xl overflow-hidden flex flex-col md:flex-row items-center">
...
<div className="w-2/3 mt-1.5 mr-1.5 p-2">
  <div className="bg-white rounded-2xl shadow-md flex flex-col justify-start p-4 h-[300px]">
    ...
    <h4 className="text-lg font-semibold">Simplificando o Processo de Aprendizagem!</h4>
  </div>
</div>
